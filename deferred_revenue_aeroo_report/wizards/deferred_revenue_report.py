...
class DeferredRevenueReport(models.TransientModel):
    _name = "deferred_revenue_report"
    _description = "Deferred Revenue Report"

    category_ids = fields.Many2many(
        string="Category",
        comodel_name="account.asset.category",
        relation="rel_deferred_revenue_report_2_category",
        column1="wizard_id",
        column2="category_id",
        domain=[
            ("type", "=", "sale"),
    ...
    def action_print_xls(self):
        ...
        report_name = "deferred_revenue_aeroo_report.aeroo_report_deferredRevenueXLS"
    ...
    def action_print_ods(self):
        ...
        report_name = "deferred_revenue_aeroo_report.aeroo_report_deferredRevenueODS"
        return self.env.ref(report_name).report_action(self, data=data)
